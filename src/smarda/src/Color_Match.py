...
colorMatch["green"] = ["acetaminophen",["advil", "tylenol", "paracetamol" , "panadol", "mapap"], ["pain","headache","fever"],325,3250,0]
colorMatch["blue"] = ["guaifenesin", ["mucinex", "tussin", "robitussin chest congestion", "humibid"], ["cough","cold"],300, 2400,0]
colorMatch["red"] = ["diazepam", ["valium", "diastat", "diastat acudial", "diazepam intensol"],["generalized anxiety", "panic", "phobias"],5,60,0]
